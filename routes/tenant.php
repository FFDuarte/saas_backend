...
Route::group([
    ...
    Route::prefix('/carros')->group(function () {
        Route::get('/', [CarrosController::class, 'index']);
        Route::post('/atualizar/{id}', [CarrosController::class, 'update']);
        Route::get('/buscar/{id}', [CarrosController::class, 'show']);
        Route::delete('/deletar/{id}', [CarrosController::class, 'destroy']);
        Route::post('/add', [CarrosController::class, 'store']);
    ...
    Route::prefix('/clientes')->group(function () {
        Route::get('/', [ClientesController::class, 'index']);
        Route::post('/atualizar/{id}', [ClientesController::class, 'update']);
        Route::get('/buscar/{id}', [ClientesController::class, 'show']);
        Route::delete('/deletar/{id}', [ClientesController::class, 'destroy']);
        Route::post('/add', [ClientesController::class, 'store']);
    });

    Route::prefix('/pecas')->group(function () {
        Route::get('/', [PecasController::class, 'index']);
        Route::post('/atualizar/{id}', [PecasController::class, 'update']);
        Route::get('/buscar/{id}', [PecasController::class, 'show']);
        Route::delete('/deletar/{id}', [PecasController::class, 'destroy']);
        Route::post('/add', [PecasController::class, 'store']);
    });

    Route::prefix('/os')->group(function () {
        Route::get('/', [OsController::class, 'index']);
        Route::post('/atualizar/{id}', [OsController::class, 'update']);
        Route::get('/buscar/{id}', [OsController::class, 'show']);
        Route::delete('/deletar/{id}', [OsController::class, 'destroy']);
        Route::post('/add', [OsController::class, 'store']);
    });
